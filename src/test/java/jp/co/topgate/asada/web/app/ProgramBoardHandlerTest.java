...
//        }
    ...
    public static class replaceInputValueメソッドのテスト {
        ...
        public void 置き換えが発生するパターン() {
            String result = ProgramBoardHandler.replaceInputValue("<script>");
            assertThat(result, is("&lt;script&gt;"));

            result = ProgramBoardHandler.replaceInputValue("te&st");
            assertThat(result, is("te&amp;st"));

            result = ProgramBoardHandler.replaceInputValue("t\"e\'s&t");
            assertThat(result, is("t&quot;e&#39;s&amp;t"));
        }

        @Test
        public void 発生しないパターン() {
            String result = ProgramBoardHandler.replaceInputValue("アイウエオ");
    ...
    public static class messageBodyParseメソッドのテスト {
        ...
        public void 正しく取り出せるか() {
            Map<String, String> sut = ProgramBoardHandler.messageBodyParse("name%3dasada%26title%3dtest%26text%3d%e3%81%93%e3%82%93%e3%81%ab%e3%81%a1%e3%81%af%26password%3dtest%26param%3dcontribution");
        ...
        public void 不正なリクエストを送ると例外が発生する() {
            ProgramBoardHandler.messageBodyParse("");
        }
    }
